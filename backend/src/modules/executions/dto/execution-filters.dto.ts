...
import { ExecutionStatus, ExecutionTrigger, BrowserType } from '../../../database/entities/test-execution.entity';
...
export class ExecutionFiltersDto extends PaginationDto {
  ...
  @ApiPropertyOptional({ description: 'Filter by start date (ISO 8601)', example: '2024-01-01T00:00:00Z' })
  @IsOptional()
  @IsDateString()
  startDate?: string;

  @ApiPropertyOptional({ description: 'Filter by end date (ISO 8601)', example: '2024-12-31T23:59:59Z' })
  @IsOptional()
  @IsDateString()
  endDate?: string;
}
